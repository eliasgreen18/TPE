...
\begin{document}
	...
	\section{Predicados y Auxiliares generales}
    	...
    	\subsection{Predicados}
        	...
        	\auxpred{esVecinaEnFila}{posicion : (\ent \times \ent), vecina : (\ent \times \ent), t: $toroide$ }{posicion[1]=vecina[1] \yLuego ((casilla[0]=\longitud{t}-1 \land (vecina[0]=0 \lor vecina[0]=\longitud{t}-2)) \lor (casilla[0]=0 \land (vecina[0]=\longitud{t}-1 \lor vecina [0]=1)) \oLuego ( (vecina[0]=casilla[0]-1) \lor vecina[0]=casilla[0]+1))} \\
