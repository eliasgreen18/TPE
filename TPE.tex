...
\begin{document}
	...
	\section{Predicados y Auxiliares generales}
    	...
    	\subsection{Predicados}
        	...
        	\auxpred{esVecinaEnFila}{posicion : (\ent \times \ent), vecina : (\ent \times \ent), t: $toroide$ }{posicion[0]=vecina[0] \yLuego ((casilla[1]=\longitud{t[0]}-1 \land (vecina[1]=0 \lor vecina[1]=\longitud{t[0]}-2)) \lor (casilla[1]=0 \land (vecina[1]=\longitud{t[0]}-1 \lor vecina [1]=1)) \oLuego ( (vecina[1]=casilla[1]-1) \lor vecina[1]=casilla[1]+1))} \\
        	
        	\auxpred{esVecinaEnColumna}{Posicion : (\ent \times \ent), posvec : (\ent \times \ent), t: $toroide$ }{posicion[1]=vecina[1] \yLuego ((casilla[0]=\longitud{t}-1 \land (vecina[0]=0 \lor vecina[0]=\longitud{t}-2)) \lor (casilla[0]=0 \land (vecina[0]=\longitud{t}-1 \lor vecina [0]=1)) \oLuego ( (vecina[0]=casilla[0]-1) \lor vecina[0]=casilla[0]+1))} \\
