...
\begin{document}
	...
	\section{Problemas}
    	...
    	\begin{proc}{seleccionNatural}{\In ts: \TLista{$toroide$}, \Out res: \ent}{}
    		...
    		\post{enRango(res, ts) \yLuego ((\exists i:\ent)(enRango(i,ts) \yLuego (toroideInmortal(ts[i]) \land res = i)) \lor (\exists h : \ent)(esNatural(h) \yLuego ticksParaMorir(t[res], h)  \land (\exists k: \ent) (esNatural(k) \land (\forall j:\ent)(enRango(j,ts) \implicaLuego  ticksParaMorir(t[j], k) \land h \geq k)))))}
    	\end{proc} \\ 
    	...
    	\begin{proc}{cantidadBloques}{\In t: $toroide$, \Out cant: \ent}{}
        	\pre{esValido(t) \yLuego soloTieneBloques(t)}
	...
	\section{Auxiliares}
    	...
    	\subsection{Predicados} \vspace{1em}
	        ...
	        \auxpred{esBloque}{t:$toroide$, i: \ent, j: \ent}{estaViva(t, i, j) \land cantVecinasVivas(t, (i,j))=3 \land estaViva(t, ((i+1) \mod \longitud{t}), j) \land cantVecinasVivas(t, (((i+1) \mod \longitud{t}),j))=3 \land estaViva(t,((i+1) \mod \longitud{t}), ((j+1)\mod \longitud{t[0]})) \land cantVecinasVivas(t, (((i+1) \mod \longitud{t}),((j+1)\mod \longitud{t[0]})))=3 \land estaViva(t, i, ((j+1)\mod \longitud{t[0]})) \land cantVecinasVivas(t, (i,((j+1)\mod \longitud{t[0]})))=3}\\
